...
import com.everis.cobol.bcoestado.programas.nuevos.HandleIgnoreRule;
import com.everis.cobol.bcoestado.programas.nuevos.WriteOperatorRule;
...
public class CobolCustomCheckRepository implements CobolCheckRepository, RulesDefinition {
  ...
  public Collection<Object> getCheckClassesOrObjects() {
    return Arrays.asList(
      ...
      GoToCallRule.class,
      HandleIgnoreRule.class,
      WriteOperatorRule.class);
  }
  ...
  public void define(Context context) {
    ...
    remediationCosts.put("GoToCallRule", "5min");
    remediationCosts.put("HandleIgnoreRule", "10min");
    remediationCosts.put("WriteOperatorRule", "15min");
